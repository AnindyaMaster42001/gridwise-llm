...
video. Do not show `.env`, provider dashboards, headers, or raw error logs.
...
| 0:20–0:50 | README architecture | “Gemini produces structured directives. OpenRouter is our alternate model route. Model output is untrusted: deterministic guardrails check types, note mapping, hours, and numbers before the optimizer receives constraints.” |
